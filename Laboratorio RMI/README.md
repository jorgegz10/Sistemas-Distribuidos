...
Otro aspecto clave fue la necesidad de implementar todo un esquema de control de concurrencia y sincronización en el servidor para manejar varias solicitudes concurrentes. Esto permitió observar la importancia de evitar situaciones de carrera y controlar la integridad de los datos, sobre todo en operaciones de préstamo y devolución. Así mismo, se evidenció que para separar la lógica de negocio de la lógica de comunicación en interfaces ayuda a lograr esta separación.
